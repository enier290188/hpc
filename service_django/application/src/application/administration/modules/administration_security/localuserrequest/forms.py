# -*- coding: utf-8 -*-
from src.application.security import models, tasks, utils
...
class LOCALUserRequestDetail(forms.ModelForm):
...
class LOCALUserRequestApprove(forms.ModelForm):
    class Meta:
        model = models.LOCALUserRequest
        fields = ['id', ]
    ...
    def ___approve___(self):
        instance_mirror = models.LOCALUser.objects.create(
...
class LOCALUserRequestDisapprove(forms.ModelForm):
    class Meta:
        model = models.LOCALUserRequest
        fields = ['id', ]
